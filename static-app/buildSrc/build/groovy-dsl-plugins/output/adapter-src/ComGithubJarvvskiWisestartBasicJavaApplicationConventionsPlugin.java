...
/**
 * Precompiled com.github.jarvvski.wisestart.basic.java-application-conventions script plugin.
 **/
public class ComGithubJarvvskiWisestartBasicJavaApplicationConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_ComGithubJarvvskiWisestartBasicJavaApplicationConventions").asSubclass(BasicScript.class);
            ...
            target.getPluginManager().apply("com.github.jarvvski.wisestart.basic.java-common-conventions");
            target.getPluginManager().apply("application");


            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_ComGithubJarvvskiWisestartBasicJavaApplicationConventions").asSubclass(BasicScript.class);
