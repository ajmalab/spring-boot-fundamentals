...
/**
 * Precompiled com.github.jarvvski.wisestart.basic.java-library-conventions script plugin.
 **/
public class ComGithubJarvvskiWisestartBasicJavaLibraryConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_ComGithubJarvvskiWisestartBasicJavaLibraryConventions").asSubclass(BasicScript.class);
            ...
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_ComGithubJarvvskiWisestartBasicJavaLibraryConventions").asSubclass(BasicScript.class);
