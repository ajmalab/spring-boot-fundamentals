...
/**
 * Precompiled com.github.jarvvski.wisestart.basic.java-common-conventions script plugin.
 **/
public class ComGithubJarvvskiWisestartBasicJavaCommonConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_ComGithubJarvvskiWisestartBasicJavaCommonConventions").asSubclass(BasicScript.class);
            ...
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_ComGithubJarvvskiWisestartBasicJavaCommonConventions").asSubclass(BasicScript.class);
